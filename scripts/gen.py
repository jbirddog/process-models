...
def generate_manifest_and_workflow_specs(bpmn_files):
    ctx = ParsingContext(
    ...
    print(json.dumps(ctx.process_ids_by_bpmn_file, sort_keys=True, indent=2))

if __name__ == "__main__":
    bpmn_files = glob("bpmn/**/*.bpmn")
    generate_manifest_and_workflow_specs(bpmn_files)
